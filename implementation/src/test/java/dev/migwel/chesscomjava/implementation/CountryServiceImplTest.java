...
class CountryServiceImplTest {
    ...
    void before() throws URISyntaxException, IOException {
        ...
        when(httpClient.httpGet(contains("country"))).thenReturn(countryJson);
        when(httpClient.httpGet(contains("players"))).thenReturn(countryPlayersJson);
        when(httpClient.httpGet(contains("clubs"))).thenReturn(countryClubsJson);
    }
